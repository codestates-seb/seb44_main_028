...
![쿼리 키](https://github.com/codestates-seb/seb44_main_028/assets/117507731/aa7a6e66-1146-4728-8d9d-5da3ff628605)
...
**결과**
- 테스트의 경우 막연히 진입 장벽이 높을 것으로 예상했지만, 순수함수 입출력 테스트의 경우 예상했던 것에 비해서는 난이도가 높지 않아 테스트 시작 자체는 큰 부담이 없었습니다.
